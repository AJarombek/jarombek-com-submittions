  ...
  return (
    <FeaturePage>
      ...
      <div className="demo-body">
        <p>
          Ref Forwarding is when refs are passed through a component to a React element in their
          render method.  Passing refs through props does not work, so special logic is needed.  If
          you try to pass a ref as a prop, it will be bound to the component instead of the
